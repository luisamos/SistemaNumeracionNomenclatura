...
{
    /// <summary>
    /// Clase: Ficha Catastral de Vías Urbanas - Componente Urbano
    /// Autor                   : Luis Amos
    /// Fecha de Creación       : 01 - 02 - 2011
    /// Fecha de Modificación   : 21 - 02 - 2012
    /// </summary>
    public class cFicha_Catastral_Vias_Urbanas_Componente_Urbano : cFicha
    {
        ...
        /// Clase: Ficha Catastral de Vías Urbanas - Componente Urbano
        /// </summary>
        public cFicha_Catastral_Vias_Urbanas_Componente_Urbano()
        {
            try
            {
                server.agregar_table_mapping("VS_LISTAR_FICHA_CATASTRAL_VIAS_URBANAS_COMPONENTE_URBANO",
                server.parametro("ID"),
                ...
                server.agregar_sp("GUARDAR_FICHA_CATASTRAL_VIAS_URBANAS_COMPONENTE_URBANO", 'G',
                server.parametro(),                
                ...
                server.agregar_sp("MODIFICAR_FICHA_CATASTRAL_VIAS_URBANAS_COMPONENTE_URBANO", 'M',
                server.parametro(),
                ...
                server.agregar_sp("ELIMINAR_FICHA_CATASTRAL_VIAS_URBANAS_COMPONENTE_URBANO", 'E',
                server.parametro(),
                server.parametro("@ID", SqlDbType.BigInt, "ID", null),
                server.parametro("@USUARIO", SqlDbType.VarChar, 10, "USUARIO MODIFICA",null));
            }
            ...
            {
                throw new sqlServerException("Error Iniciar el Objeto, Ficha Catastral de Vías Urbanas - Componente Urbano. ", ex);
            }
        }
        ...
        public int actualizar(FICHA_ds tabla)
        {
            try
            {
                i = server.actualizar(tabla, "VS_LISTAR_FICHA_CATASTRAL_VIAS_URBANAS_COMPONENTE_URBANO");
            }
            catch (Exception ex)
            {
                i = -2;
                throw new sqlServerException("Error Actualizar, Ficha Catastral de Vías Urbanas - Componente Urbano. ", ex);
            }
            return i;
        }
        #endregion
